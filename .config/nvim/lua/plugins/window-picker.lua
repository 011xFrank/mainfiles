            ...
            highlights = {
                ...
                statusline = {
                    focused = {
                        ...
                        bg = '#6a818c', -- A muted, slightly desaturated blue-grey (ash-like)
                        bold = true,
                    },
                    unfocused = {
                        fg = '#b3b3b3', -- A soft grey
                        bg = '#4e5b63', -- A darker, cool grey for unfocused elements
                        bold = true,
                    },
                },
                winbar = {
                    focused = {
                        fg = '#ffffff', -- Bright white for contrast
                        bg = '#6a818c', -- Matching the statusline focused color
                        bold = true,
                    },
                    unfocused = {
                        fg = '#b3b3b3', -- A soft grey
                        bg = '#4e5b63', -- Matching the statusline unfocused color
                        bold = true,
                    },
                },
            },
